    ...
    const groupMenu = (groupOption: DropDownGroup[]) => {
      return groupOption.map((group: DropDownGroup, key) => {
        return (
          <div
            key={key}
            className="flex flex-col space-y-2 font-semibold text-base mb-2"
          >
            {group.groupLabel ? (
        ...
        {groupedOptions.length > 1 ? (
          <div className="mx-auto flex items-center justify-center">
            <div className="group relative cursor-pointer">
              <div className="flex items-center justify-between space-x-5 bg-white px-4">
                <div className="menu-hover my-2 py-2 text-2xl font-bold text-black lg:mx-4">
                  {label}
                </div>
              </div>

              <div className="grid grid-cols-2 min-w-[40rem] invisible text-lg absolute group-hover:visible bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="mx-auto flex items-center justify-center">
            <div className="group relative cursor-pointer">
              ...
              <div className="invisible text-lg absolute group-hover:visible min-w-[10rem] bg-white rounded-lg shadow-xl p-4">
